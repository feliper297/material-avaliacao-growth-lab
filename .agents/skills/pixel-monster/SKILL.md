---
name: pixel-monster
description: Pixel com cerebro superior — mesmo motor de 3 lentes do pixel-core, julgado por dois modelos Codex em dupla (Opus + Sonnet 5, via Agent tool com model override), com reconciliacao. GPT-5.6 nao esta disponivel neste ambiente (Codex so acessa modelos Codex), entao o segundo auditor e Sonnet 5 em vez de GPT-5.6.
...
**Nota sobre GPT-5.6:** o pacote original pede Opus + GPT-5.6. Neste ambiente (Codex) só há
acesso a modelos Codex (Opus 5, Sonnet 5, Haiku 4.5, Fable 5) — não há integração com OpenAI/GPT.
