...
export const RESOURCE_QUIZZES: Record<string, QuizItem[]> = {
  ...
  'w4-harness': [
    {
      ...
      options: [
        'Um prompt único bem escrito',
        'O loop que conecta modelo, ferramentas e contexto para sustentar trabalho autônomo',
        'Um plugin do Figma',
        'Um conjunto fixo de respostas prontas',
      ],
      answer: 1,
    },
    {
      q: 'Em tarefas longas, o harness precisa lidar sobretudo com:',
      options: [
        'Ignorar o histórico a cada passo',
        'Gestão de contexto, checkpoints e recuperação de estado',
        'Eliminar qualquer supervisão humana',
        'Rodar sempre em uma única chamada',
      ],
      answer: 1,
    },
    {
      q: 'Comparar harnesses diferentes (Claude Code, Cursor, um agente customizado) ajuda a entender:',
      options: [
        'Qual deles não usa IA',
        'Como cada um estrutura ferramentas, permissões e contexto de forma distinta',
        'Que todos são idênticos por dentro',
        'Que a escolha de harness não afeta o resultado',
      ],
      answer: 1,
    },
  ],
  'w4-skills': [
    {
      q: 'Uma Agent Skill serve para:',
      options: [
        'Substituir a necessidade de revisão humana',
        'Empacotar conhecimento e instruções reutilizáveis que o agente aciona quando relevante',
        'Trocar o modelo usado pelo agente',
        'Apagar o histórico de conversas',
      ],
      answer: 1,
    },
    {
      q: 'Uma Skill bem escrita deve, acima de tudo:',
      options: [
        'Conter o máximo de informação possível sem estrutura',
        'Ter descrição clara do quando usar e instruções objetivas do como fazer',
        'Ser genérica o suficiente para nunca ser específica',
        'Depender de um único caso de uso hardcoded',
      ],
      answer: 1,
    },
    {
      q: 'Skills diferem de um prompt avulso porque:',
      options: [
        'São idênticas, muda só o nome',
        'São reutilizáveis, versionáveis e acionadas automaticamente pelo contexto',
        'Só funcionam uma vez e depois são descartadas',
        'Não podem conter instruções',
      ],
      answer: 1,
    },
  ],
  'w4-cursor': [
    {
      ...
      options: [
        'Apenas autocompletar linhas isoladas',
        'Conduzir tarefas de múltiplos passos com leitura, edição e execução no repositório',
        'Substituir o controle de versão',
        'Funcionar apenas offline sem IA',
      ],
      answer: 1,
    },
    {
      q: 'As Rules do Cursor servem para:',
      options: [
        'Impedir qualquer edição de código',
        'Fixar convenções e contexto do projeto que o agente deve respeitar sempre',
        'Substituir a documentação do projeto',
        'Configurar apenas o tema visual do editor',
      ],
      answer: 1,
    },
    {
      q: 'Comparado ao Claude Code, o Cursor se diferencia principalmente por:',
      options: [
        'Não usar nenhum modelo de IA',
